...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("HEMANG SHEORAN ❯ ") + chalk.hex("#00ffff")("fixed by Hemang Sheoran"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ HEMANG SHEORAN ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
