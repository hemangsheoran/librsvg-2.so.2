...
event.body.indexOf("Hlo")==0 || event.body.indexOf("hi")==0 || event.body.indexOf("hlo")==0 || event.body.indexOf("Hello")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
			}
			api.sendMessage(msg, threadID, messageID);
 ...
 event.body.indexOf("India")==0 || event.body.indexOf("india")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
			}
			api.sendMessage(msg, threadID, messageID);
