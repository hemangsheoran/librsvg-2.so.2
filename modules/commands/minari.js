...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, Hemang.") {
    api.sendMessage(`I made by master SaikiDesu, also known as John Paul Caigas`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is Hemang's laptop. What is your birthplace?") {
    api.sendMessage(`I live here in Delhi, India. What about you?`, event.threadID, event.messageID)
    return;
              } 
    ...
    return;
            ...
            if(res === "I was created by Hemang.") {
